      ...
      <div className="2xl:hidden block absolute -mt-5 top-28 py-5 w-full left-0 right-0  bg-primary transition z-50">
        <ul className="text-center text-xl p-5">
          <Link spy={true} smooth={true} to="Nosotros">
            <li className="text-white  my-4 py-5 border-b border-slate-800 hover:bg-slate-800 hover:font-bold hover:rounded">Nosotros</li>
          </Link>
          <Link spy={true} smooth={true}to="HechoEnCasa">
            <li className="text-white my-4 py-4 border-b border-slate-800 hover:bg-slate-800 hover:font-bold hover:rounded">Hecho en casa</li>
          </Link>
          <Link spy={true} smooth={true}to="Servicios">
            <li className="text-white my-4 py-4 border-b border-slate-800 hover:bg-slate-800 hover:font-bold hover:rounded">Servicios</li>
          </Link>
          <Link spy={true} smooth={true}to="Contacto">
            <li className="text-white my-4 py-4  border-slate-800 hover:bg-slate-800 hover:font-bold hover:rounded">Contacto</li>
          </Link>
        </ul>
      </div>
  </>
